...
INSERT INTO restaurants (name, category, description, image_url, delivery_fee, min_order_amount, rating) VALUES
('황금올리브치킨', '치킨', '바삭한 후라이드와 매콤달콤 양념치킨 전문점', '🍗', 3000, 15000, 4.7),
('마포분식',       '분식', '떡볶이·김밥·튀김이 맛있는 동네 분식집',     '🍢', 2000,  8000, 4.5),
('나폴리피자',     '피자', '화덕에 구운 정통 나폴리 스타일 피자',       '🍕', 3500, 18000, 4.6),
('하루카페',       '카페', '핸드드립 커피와 수제 디저트',               '☕', 2500, 10000, 4.8);
